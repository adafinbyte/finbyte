...
export function NavUser({
  ...
  return (
    <SidebarMenu>
      {!connected ?
        <SidebarMenuButton onClick={() => set_wallet_modal_open(true)}>
          <Plug />
      ...
      <WalletLoginModal open={wallet_modal_open} close_modal={() => set_wallet_modal_open(false)} onOpenChange={set_wallet_modal_open} />
    </SidebarMenu>
  )
}
