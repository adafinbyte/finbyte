...
import { ArrowRight, Ellipsis, Heart, MessageCircle, VerifiedIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import Link from "next/link";
import { FC } from "react";
import { comment_post_data, create_comment_post_data, forum_post_data, post_with_comments } from "@/utils/api/interfaces";
...
interface custom_props {
  ...
  on_create: (details: create_comment_post_data) => void;
  original_post_author: string;
}

const ForumCommentComponent: FC <custom_props> = ({
  comment_post, is_registered, on_create, original_post_author
}) =>{
        ...
        <div className="flex gap-4 items-center relative">
          ...
          <div className="mt-2 relative">
            ...
            <div className="inline-flex gap-2">
              <Button size={'sm'} disabled={!connected} variant='ghost'>
